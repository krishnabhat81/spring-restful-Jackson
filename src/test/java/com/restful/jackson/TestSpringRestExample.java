...
import com.restful.jackson.model.Employee;
import com.restful.jackson.utility.EmpRestURIConstants;
...
public class TestSpringRestExample {
	public static final String SERVER_URI = "http://localhost:8090/jackson";
	...
	private static void testCreateEmployee() {
		...
		emp.setId(1);emp.setName("Krishna Bhat");
